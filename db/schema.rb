...
ActiveRecord::Schema.define(version: 2024_05_21_123716) do
  ...
  create_table "authorities", id: :integer, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    ...
    t.index ["person_id"], name: "index_authorities_on_person_id"
  ...
  create_table "sitenotices_users", id: false, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
