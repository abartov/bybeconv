...
ActiveRecord::Schema.define(version: 2022_06_01_005408) do
  ...
  create_table "base_user_preferences", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin", force: :cascade do |t|
