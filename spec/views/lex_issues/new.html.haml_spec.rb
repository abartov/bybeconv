...
RSpec.describe "lex_issues/new", type: :view do
  before(:each) do
    assign(:lex_issue, LexIssue.new(
      subtitle: "MyString",
      volume: "MyString",
      issue: "MyString",
      seq_num: 1,
  ...
  it "renders new lex_issue form" do
    render

    assert_select "form[action=?][method=?]", lex_issues_path, "post" do
